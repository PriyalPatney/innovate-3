var data = {"common" : [{
     ...
     },
    {
     ...
     {
        "name" : "Tech-Painting",
        "desc" : "When expertise in art and science had not yet matured to the polarized state in which they exist today, they co-existed naturally. In Da Vinci’s words “Art is the queen of all sciences and communicating knowledge to all the generations of the world”. We at INNOVATE heartily invite the creators of tomorrow to evince the charisma of paint and blade.Tech Painting is all about creating an art form from the regular electronic components and present them in a,way unimaginable to many.So get your palettes and paints ready for one of the most awaited event of INNOVATE 2018.RULES: 1. Painting must be completed in the specified allowed time.2. A presentation of 5 minutes(maximum) has to be given on the created design.3. No computer software is allowed for the purpose of design .4.Decision of the judges shall be final.",
    ...
    },
    {
    ...
    },
     {
        ...
        "link1": "https://goo.gl/forms/K8NXsAeKxKtFOQgt2",
        "link2":"Register Here"
    },
     {
        "name" : "Sargam",
...
for(i=0; i<=item.length - 1; i++){
    ...
    let link2 = item[i].link2;
    self.cardCreator(name,desc,link,link1,link2);

}
function cardCreator(name,desc,link,link1,link2){
    const template = `
